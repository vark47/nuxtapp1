jQuery("#simulation")
  .on("pageload", ".s-24b1585a-c56f-4f05-930f-e84fdc387c90 .pageload", function(event, data) {
  ...
  .on("windowscroll", ".s-24b1585a-c56f-4f05-930f-e84fdc387c90 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
