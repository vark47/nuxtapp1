jQuery("#simulation")
  .on("click", ".s-c9e2a4f9-39e2-46ac-8efa-83481e3e8f7b .click", function(event, data) {
  ...
  .on("pageload", ".s-c9e2a4f9-39e2-46ac-8efa-83481e3e8f7b .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-c9e2a4f9-39e2-46ac-8efa-83481e3e8f7b .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
