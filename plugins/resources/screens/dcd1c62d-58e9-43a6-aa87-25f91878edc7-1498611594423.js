jQuery("#simulation")
  .on("click", ".s-dcd1c62d-58e9-43a6-aa87-25f91878edc7 .click", function(event, data) {
  ...
  .on("pageload", ".s-dcd1c62d-58e9-43a6-aa87-25f91878edc7 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-dcd1c62d-58e9-43a6-aa87-25f91878edc7 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
