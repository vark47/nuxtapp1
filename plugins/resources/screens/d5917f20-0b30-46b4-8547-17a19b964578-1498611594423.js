jQuery("#simulation")
  .on("click", ".s-d5917f20-0b30-46b4-8547-17a19b964578 .click", function(event, data) {
  ...
  .on("pageload", ".s-d5917f20-0b30-46b4-8547-17a19b964578 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-d5917f20-0b30-46b4-8547-17a19b964578 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
