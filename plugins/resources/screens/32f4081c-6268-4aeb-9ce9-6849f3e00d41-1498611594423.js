jQuery("#simulation")
  .on("pageload", ".s-32f4081c-6268-4aeb-9ce9-6849f3e00d41 .pageload", function(event, data) {
  ...
  .on("windowscroll", ".s-32f4081c-6268-4aeb-9ce9-6849f3e00d41 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
