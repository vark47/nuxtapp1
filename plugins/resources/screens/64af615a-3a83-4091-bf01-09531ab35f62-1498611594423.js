jQuery("#simulation")
  .on("pageload", ".s-64af615a-3a83-4091-bf01-09531ab35f62 .pageload", function(event, data) {
  ...
  .on("windowscroll", ".s-64af615a-3a83-4091-bf01-09531ab35f62 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
