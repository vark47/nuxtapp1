jQuery("#simulation")
  .on("click", ".s-50f57da1-05c7-4903-ade5-ab0af58c81f9 .click", function(event, data) {
  ...
  .on("pageload", ".s-50f57da1-05c7-4903-ade5-ab0af58c81f9 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-50f57da1-05c7-4903-ade5-ab0af58c81f9 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
