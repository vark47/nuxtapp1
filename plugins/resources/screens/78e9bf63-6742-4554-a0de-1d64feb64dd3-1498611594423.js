jQuery("#simulation")
  .on("pageload", ".s-78e9bf63-6742-4554-a0de-1d64feb64dd3 .pageload", function(event, data) {
  ...
  .on("windowscroll", ".s-78e9bf63-6742-4554-a0de-1d64feb64dd3 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
